...
import com.example.postgresqinformationschema.tables.records.SqlFeaturesRecord;
...
public class SqlFeatures extends TableImpl<SqlFeaturesRecord> {
    ...
    private static final long serialVersionUID = 1669188673;
     ...
     */
    public final TableField<SqlFeaturesRecord, String> FEATURE_ID = createField(DSL.name("feature_id"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_features.feature_name</code>.
     */
    public final TableField<SqlFeaturesRecord, String> FEATURE_NAME = createField(DSL.name("feature_name"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_features.sub_feature_id</code>.
     */
    public final TableField<SqlFeaturesRecord, String> SUB_FEATURE_ID = createField(DSL.name("sub_feature_id"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_features.sub_feature_name</code>.
     */
    public final TableField<SqlFeaturesRecord, String> SUB_FEATURE_NAME = createField(DSL.name("sub_feature_name"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_features.is_supported</code>.
     */
    public final TableField<SqlFeaturesRecord, String> IS_SUPPORTED = createField(DSL.name("is_supported"), org.jooq.impl.SQLDataType.VARCHAR(3), this, "");

    /**
     * The column <code>information_schema.sql_features.is_verified_by</code>.
     */
    public final TableField<SqlFeaturesRecord, String> IS_VERIFIED_BY = createField(DSL.name("is_verified_by"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_features.comments</code>.
     */
    public final TableField<SqlFeaturesRecord, String> COMMENTS = createField(DSL.name("comments"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
