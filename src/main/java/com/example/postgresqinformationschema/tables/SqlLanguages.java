...
import com.example.postgresqinformationschema.tables.records.SqlLanguagesRecord;
...
public class SqlLanguages extends TableImpl<SqlLanguagesRecord> {
    ...
    private static final long serialVersionUID = 745923000;
     ...
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_SOURCE = createField(DSL.name("sql_language_source"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_languages.sql_language_year</code>.
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_YEAR = createField(DSL.name("sql_language_year"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_languages.sql_language_conformance</code>.
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_CONFORMANCE = createField(DSL.name("sql_language_conformance"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_languages.sql_language_integrity</code>.
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_INTEGRITY = createField(DSL.name("sql_language_integrity"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_languages.sql_language_implementation</code>.
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_IMPLEMENTATION = createField(DSL.name("sql_language_implementation"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_languages.sql_language_binding_style</code>.
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_BINDING_STYLE = createField(DSL.name("sql_language_binding_style"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_languages.sql_language_programming_language</code>.
     */
    public final TableField<SqlLanguagesRecord, String> SQL_LANGUAGE_PROGRAMMING_LANGUAGE = createField(DSL.name("sql_language_programming_language"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
