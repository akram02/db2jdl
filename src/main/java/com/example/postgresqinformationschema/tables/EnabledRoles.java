...
import com.example.postgresqinformationschema.tables.records.EnabledRolesRecord;
...
public class EnabledRoles extends TableImpl<EnabledRolesRecord> {
    ...
    private static final long serialVersionUID = -912337906;
     ...
     */
    public final TableField<EnabledRolesRecord, String> ROLE_NAME = createField(DSL.name("role_name"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
