...
import com.example.postgresqinformationschema.tables.records.SqlSizingProfilesRecord;
...
public class SqlSizingProfiles extends TableImpl<SqlSizingProfilesRecord> {
    ...
    private static final long serialVersionUID = -639130474;
     ...
     */
    public final TableField<SqlSizingProfilesRecord, Integer> SIZING_ID = createField(DSL.name("sizing_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>information_schema.sql_sizing_profiles.sizing_name</code>.
     */
    public final TableField<SqlSizingProfilesRecord, String> SIZING_NAME = createField(DSL.name("sizing_name"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_sizing_profiles.profile_id</code>.
     */
    public final TableField<SqlSizingProfilesRecord, String> PROFILE_ID = createField(DSL.name("profile_id"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.sql_sizing_profiles.required_value</code>.
     */
    public final TableField<SqlSizingProfilesRecord, Integer> REQUIRED_VALUE = createField(DSL.name("required_value"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>information_schema.sql_sizing_profiles.comments</code>.
     */
    public final TableField<SqlSizingProfilesRecord, String> COMMENTS = createField(DSL.name("comments"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
